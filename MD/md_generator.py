...
def merge(old, new):
    old_parts = old.split(LEETCODE_END)
    new_parts = new.split(LEETCODE_END)
    if len(old_parts) == 1:
        return '{}'.format(new)
    return '{}{}{}{}{}'.format(old_parts[0], new_parts[0], LEETCODE_END, old_parts[1], new_parts[1])
